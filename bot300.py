...
while True:
	try:
		...
		if x == counter:
			...
			cursor = db.cursor()
			cursor.execute("INSERT INTO 5min (num1,coin1,num2,coin2,num3,coin3,num4,coin4,num5,coin5,num6,coin6,num7,coin7,num8,coin8,num9,coin9,num10,coin10, date) VALUES (" 
